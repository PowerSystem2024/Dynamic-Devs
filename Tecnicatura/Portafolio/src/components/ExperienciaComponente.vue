...
const experiencias = ref([
    { id: 1, src: icono1, parrafo: 'Trabajamos en un equipo de 5 desarrolladores en la creación de una plataforma de comercio electrónico que incrementó las ventas en un 35% durante el primer año.' },
